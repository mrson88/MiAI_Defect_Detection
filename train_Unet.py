...
from pre_train_Unet import multi_unet_model, jacard_coef  
...
model = load_model("/home/mrson/python_code/hoc_deeplearning/MiAI_Defect_Detection/models/satellite_standard_unet_100epochs.hdf5",
